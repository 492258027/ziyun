...
func (e Endpoints) Auth(ctx context.Context, in *pb.AuthRequest) (*pb.AuthResponse, error) {
	response, err := e.AuthEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
...
func MakeHealthEndpoint(s pb.AuthServer) endpoint.Endpoint {
...
func MakeAuthEndpoint(s pb.AuthServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(*pb.AuthRequest)
		v, err := s.Auth(ctx, req)
		if err != nil {
			return nil, err
		}
		return v, nil
...
func (e *Endpoints) WrapAllExcept(middleware endpoint.Middleware, excluded ...string) {
	...
	for inc := range included {
		...
		if inc == "Auth" {
			e.AuthEndpoint = middleware(e.AuthEndpoint)
		}
	}
}
...
func (e *Endpoints) WrapAllLabeledExcept(middleware func(string, endpoint.Endpoint) endpoint.Endpoint, excluded ...string) {
	...
	for inc := range included {
		...
		if inc == "Auth" {
			e.AuthEndpoint = middleware("Auth", e.AuthEndpoint)
		}
	}
}
